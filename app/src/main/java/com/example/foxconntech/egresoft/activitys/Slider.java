...
public class Slider extends AppCompatActivity implements uno.OnFragmentInteractionListener,dos.OnFragmentInteractionListener
,tres.OnFragmentInteractionListener,cuatro.OnFragmentInteractionListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab=(FloatingActionButton) findViewById(R.id.btnFlotante);
