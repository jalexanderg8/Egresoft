...
public class P_AcademicoFragment extends Fragment {
    ...
    private static final String url="http://oferta.senasofiaplus.edu.co/sofia-oferta/buscar-oferta-educativa.html";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View vista=inflater.inflate(R.layout.fragment_p__academico, container, false);

        WebView webView=vista.findViewById(R.id.webView2);
